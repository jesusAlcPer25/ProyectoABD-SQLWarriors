...
CREATE TABLESPACE TS_PLYTIX DATAFILE 'C:\APP\ALUMNOS\ORADATA\ORCL\PLYTIX01.DBF' SIZE 500M AUTOEXTEND ON;
CREATE TABLESPACE TS_INDICES DATAFILE 'C:\APP\ALUMNOS\ORADATA\ORCL\INDICES01.DBF' SIZE 50M AUTOEXTEND ON;
...
ALTER TABLE producto ADD (PUBLICO CHAR(1) DEFAULT 'S' NOT NULL);
